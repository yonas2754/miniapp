...
function Page() {
  return (
   ...
   <BackButtonDemo/>   
   <div className=" bg-ethBlack-950  p-8  grid grid-cols-3 gap-0 ">
    ...
    <div className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-[calc(100%-2rem)] max-w-xl bg-[#272a2f] flex justify-around items-center z-50 rounded-3xl text-xs p-4">
